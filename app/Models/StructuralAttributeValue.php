...
class StructuralAttributeValue extends Model
{
    ...
    public function attribute() : BelongsTo { return $this->belongsTo(StructuralAttribute::class, 'attribute_id')->with('fields'); }
    public function fieldsValues() : HasMany { return $this->HasMany(StructuralFieldValue::class, 'attribute_value_id')->with('field'); }
}
